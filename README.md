# eds220-2024-inclass
In class eds 220 notes

# EDS 220 In-Class Repository
This repository hosts all the work completed in-class by Yos Ramirez during the EDS 220 - *Working with Environmental Datasets* lectures.
## Course Information
